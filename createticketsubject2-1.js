function CreateTicketSubject() {
	...
	var BrandField = loader.engine.document.getElementById(116819571); // get the Brand Name Field
	var BrandValue = BrandField.getProperty('value.value'); // get the Brand Name value
    console.log("Brand value:", BrandValue);

	var OrderNumberField = loader.engine.document.getElementById(116819252); // get the Order Number field
	var OrderValue = OrderNumberField.getProperty('value.value'); // get the Order Number Value value
    console.log("Brand value:", BrandValue);

	var formattedTicketSubjectField = loader.engine.document.getElementById(116819573); // Get Formatted Ticket Subject Field
